package com.example.ahmedraza.quiz_app;
        ...
        button.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(selectedId == sound.getId()) {
                    Toast.makeText(getApplicationContext(),+count+"choice: Vibration",
                    ...
                    Toast.makeText(getApplicationContext(),+count+5+"choice: sound",Toast.LENGTH_SHORT).show();
